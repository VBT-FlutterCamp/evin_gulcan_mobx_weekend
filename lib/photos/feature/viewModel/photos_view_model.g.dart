...
mixin _$PhotosViewModel on _PhotosViewModelBase, Store {
  final _$photosModelAtom = Atom(name: '_PhotosViewModelBase.photosModel');

  @override
  List<PhotosModel>? get photosModel {
    _$photosModelAtom.reportRead();
    return super.photosModel;
  }

  @override
  set photosModel(List<PhotosModel>? value) {
    _$photosModelAtom.reportWrite(value, super.photosModel, () {
      super.photosModel = value;
    });
  }
  ...
  final _$fetchPhotosAsyncAction =
      AsyncAction('_PhotosViewModelBase.fetchPhotos');
